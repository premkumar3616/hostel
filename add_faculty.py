...
faculty = [
    ...
    Faculty( first_name="Abhirami", last_name="kunireddy", email="security@sasi.ac.in", dept="Security", faculty_phone="9440963616", room_no="17102",category="security", password_hash=generate_password_hash("security@123"), photo="static/faculty/security.jpg")
]
